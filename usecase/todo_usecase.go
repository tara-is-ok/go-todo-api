...
type ITodoUsecase interface {
	...
	GetTodosByTags(tags []string) ([]models.TodoResponse, error)
...
func (tu *todoUsecase) GetTodosByTags(tags []string) ([]models.TodoResponse, error) {
	todos := []models.Todo{}
	if err := tu.tr.GetTodosByTags(&todos, tags); err != nil {
		return nil, err
	}
	resTodos := []models.TodoResponse{}
	for _, v := range todos {
